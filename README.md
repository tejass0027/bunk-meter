...
A mobile-first attendance tracker for college students. No login, no backend —
everything is stored on your own phone/browser (`localStorage`). It's a PWA,
so you can install it on Android like a real app and it keeps working
offline.
